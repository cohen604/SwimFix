          ...
          child: Row(
            ...
            children: [
              TextButton(
                  ...
                  child: buildText(context, 'No', 21, _colorsHolder.getBackgroundForI2(), FontWeight.normal)
              ),
              TextButton(
                  onPressed: ()=>onClickYes(context),
                  child: buildText(context, 'Yes', 21, _colorsHolder.getBackgroundForI2(), FontWeight.normal)
              ),
            ],
          ),
        )
