...
import static Domain.Points.IPointUtils.calcDistance;
import static Domain.Points.IPointUtils.calcSlope;

public class ElbowErrorDetector implements ISkeletonErrorDetector {
